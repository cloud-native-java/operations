...
/**
 * Auto-configures basic connectivity to the <a
 * href="http://cloudfoundry.org">CloudFoundry</a>
 * API letting clients programmatically do things
 * like talk to the loggregator, scale instances,
 * and ask questions about the state of deployed
